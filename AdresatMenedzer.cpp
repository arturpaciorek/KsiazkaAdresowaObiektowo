...
void AdresatMenedzer :: edytujWybranaLinieWPliku(Adresat adresat, string liniaZDanymiAdresataOddzielonePionowymiKreskami)
{
...
void  AdresatMenedzer :: usunWybranaLinieWPliku(Adresat adresat)
{
    fstream odczytywanyPlikTekstowy, tymczasowyPlikTekstowy;
    string wczytanaLinia = "";
    int numerWczytanejLinii = 1;
    ...
    if (odczytywanyPlikTekstowy.good() == true && adresat.pobierzId() != 0)
    {
        while (getline(odczytywanyPlikTekstowy, wczytanaLinia))
        {
            ...
            if((usuwanaLiniaZostalaNapotkana==false) && (adresat.pobierzId() != MetodyPomocnicze::pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia)))
            {
                numerUsuwanejLinii++;
            }
            ...
            if (adresat.pobierzId() == MetodyPomocnicze::pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia)) {}
            else if (numerWczytanejLinii == 1 && (adresat.pobierzId() != MetodyPomocnicze::pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia)))
                tymczasowyPlikTekstowy << wczytanaLinia;
